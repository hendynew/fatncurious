...
<html lang="en">
  <head>
    ...
    <title>Master Restaurant | Fat 'n Curious</title>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="../resources/images/img.jpg" alt=""><?php echo $active ?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Restaurants <small>Display restaurant data</small></h3>
              </div>
            </div>
                  ...
                  <div class="x_content">
                    ...
                    ?>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Restaurant</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php
                            $array=['class'=>'form-control','name'=>'kodePemilik'];
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php
                            ...
                            echo form_input($array,$jam_buka);
                            ?>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php
                            ...
                            echo form_input($array,$hari_buka);
                            ?>
                        </div>
                      </div>
                      <div class="form-group">
