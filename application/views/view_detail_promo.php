          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Detail promo <?php echo $nama ?></h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li class="dropdown">
                        <?php
                        echo form_open('master_promo');
                        echo form_hidden("kodePromo",$kode_param);
                  ...
                  <div class="x_content">
                    ...
                    ?>
                      <div class="form-group">
                        ...
                        <?php echo form_hidden("kodePromo",$kode_param);?>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php
                            $array=['class'=>'form-control','name'=>'txtNamaPromo'];
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        ...
                        $this->table->set_heading('Restoran', 'Kartu Kredit');
                        ...
                        foreach($data2 as $d){
                          $this->table->add_row(anchor('master_user/detail/restaurant/'.$d->KODE_RESTORAN,$d->NAMA_RESTORAN),anchor('master_user/detail/kartu_kredit/'.$d->KODE,$d->NAMA));
                        }
                        ...
                        <?php
                        echo '<div class="table-responsive">';
                        $this->table->set_heading('Menu','Restoran');
                        $tmp = array('table_open'=>'<table class="example table table-striped jambo_table">','heading_row_start'=>'<th class="column-title">','row_start'=>'<tr class="odd pointer"><td></td>','row_alt_start'=> '<tr class="even pointer"><td></td>');
                        $this->table->set_template($tmp);

                        foreach($data3 as $d){
                          $this->table->add_row(anchor('master_user/detail/menu/'.$d->KODE,$d->NAMA),anchor('master_user/detail/restaurant/'.$d->KODE_RESTORAN,$d->NAMA_RESTORAN));
                        }
                        echo $this->table->generate();
                        echo '</div><br><br>';
                        ?>
