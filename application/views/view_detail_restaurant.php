          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Detail restaurant <?php echo $nama ?></h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li class="dropdown">
                        <?php
                        echo form_open('master_restaurant');
                        echo form_hidden("kodeRestoran",$kode_param);
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        ...
                        <?php
                        echo '<div class="table-responsive">';
                        $this->table->set_heading('Kode Review', 'Reviewer','Isi Review','Tanggal','Jumlah Like','Keterangan');
                        $tmp = array('table_open'=>'<table class="example table table-striped jambo_table">','heading_row_start'=>'<th class="column-title">','row_start'=>'<tr class="odd pointer"><td></td>','row_alt_start'=> '<tr class="even pointer"><td></td>');
                        $this->table->set_template($tmp);

                        foreach($data5 as $d){
                          $this->table->add_row($d->KODE,anchor('master_user/detail/user/'.$d->KODE_USER,$d->NAMA),$d->DESKRIPSI,$d->TANGGAL,$d->LIKE,$d->KETERANGAN);
                        }
                        echo $this->table->generate();
                        echo '</div><br><br>';
                        ?>
