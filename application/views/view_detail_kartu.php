          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Detail Kartu Kredit <?php echo $nama ?></h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Kartu Kredit</h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li class="dropdown">
                        <?php
                        echo form_open('master_kartu_kredit');
                        echo form_hidden("kodeKartu",$kode_param);
                  ...
                  <div class="x_content">
                    ...
                    <?php
                      ...
                      echo form_open('master_kartu_kredit',$array);
                    ?>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Kartu Kredit</label>
                        <label class="control-label col-md-1 col-sm-1 col-xs-12"><?php echo $kode_param ?></label>
                        <?php echo form_hidden("kodeKartu",$kode_param);?>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Kartu Kredit</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php
                            $array=['class'=>'form-control','name'=>'txtWeb'];
                            echo form_input($array,$website);
                            ?>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <?php
                            ...
                            echo form_submit($array,'Add Credit Card');
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>User pengguna <?php echo $nama?></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li class="dropdown">
                        <?php
                        echo form_open('master_kartu_kredit');
                        echo form_hidden("dropdownRestoran",$kode_param);
                        $array=['class'=>'btn btn-danger','name'=>'btnDelete'];
                        echo form_submit($array,'Delete');
                        echo form_close();
                        ?>
                  ...
                  <div class="x_content">
                        ...
                        $this->table->set_heading('Nama User', 'Jenis User');
                        ...
                        foreach($data2 as $d){
                          $this->table->add_row(anchor('master_user/detail/user/'.$d->KODE,$d->NAMA),$d->NAMA_JENIS);
                        }
                        echo $this->table->generate();
                        echo '</div><br><br>';
                        ?>
                        <h2>Promo <?php echo $nama?></h2>
                        <?php

                        echo '<div class="table-responsive">';
                        $this->table->set_heading('Nama Promo','Restoran');
                        $tmp = array('table_open'=>'<table class="example table table-striped jambo_table">','heading_row_start'=>'<th class="column-title">','row_start'=>'<tr class="odd pointer"><td></td>','row_alt_start'=> '<tr class="even pointer"><td></td>');
                        $this->table->set_template($tmp);

                        foreach($data3 as $d){
                          $this->table->add_row(anchor('master_user/detail/promo/'.$d->KODE,$d->NAMA),anchor('master_user/detail/restaurant/'.$d->KODE_RESTORAN,$d->NAMA_RESTORAN));
                        }
                        echo $this->table->generate();
                        echo '</div><br><br>';
                        ?>
