...
<html lang="en">
  <head>
    ...
    <title>Master Menu | Fat 'n Curious </title>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="<?php echo base_url() ?>resources/images/img.jpg" alt="Profile Image" /></span>
                        <span>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Menu <small>Display menu data</small></h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive">
                        <?php
                        $this->table->set_heading('Menu', 'Jenis Menu','Restoran','Deskripsi','Harga','Keterangan','Action');
                        ...
                        foreach($arrObj as $r){
                          $this->table->add_row(anchor('master_user/detail/menu/'.$r->KODE_MENU,$r->NAMA_MENU),$r->NAMA_JENIS, anchor('master_user/detail/restaurant/'.$r->KODE_RESTORAN,$r->NAMA_RESTORAN),$r->DESKRIPSI,$r->HARGA,$r->KETERANGAN,anchor('master_user/detail/menu/'.$r->KODE_MENU,'Detail'));
                        }
                    ...
                    ?>
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <?php
                            $array=['class'=>'form-control','name'=>'kodeMenu'];
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php
                            $array=['class'=>'form-control','name'=>'kodeJenis'];
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php
                            $array=['class'=>'form-control','name'=>'kodeRestoran'];
                            echo form_dropdown($array,$arrItem3,$selectedItem3);
                            ?>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <?php
                            ...
                            echo form_submit($array,'Insert');
                            $array=['class'=>'btn btn-success','name'=>'btnUpdate'];
                            echo form_submit($array,'Update');
