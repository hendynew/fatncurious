...
<html lang="en">
  <head>
    ...
    <title>Master Kartu Kredit | Fat 'n Curious </title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Credit Cards <small>Display credit cards data</small></h3>
              </div>
                    ...
                    ?>
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <?php
                            $array=['class'=>'form-control','name'=>'kodeKartu'];
