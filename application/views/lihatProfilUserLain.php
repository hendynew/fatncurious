      ...
      <div class="container berubahLain">
        ...
        <li class="scroll">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <?php
            //print_r($kodeUser);
            if($fotoUserYangLogin[0]->URL_FOTO == ''){
              $urlUserYangLogin = 'default.jpg';
            }else $urlUserYangLogin = $fotoUserYangLogin[0]->URL_FOTO;
            $url_fullUserYangLogin = base_url('/vendors/images/profilepicture/' . $urlUserYangLogin);
              ?>
            ...
            $url_full = base_url('/vendors/images/profilepicture/' . $url);
              ?>
            <img src="<?php echo $url_fullUserYangLogin ?>" class="img-circle displayPictureNavBar"> <span class="caret"></span>
            </a>
            <ul class="dropdown-menu">
